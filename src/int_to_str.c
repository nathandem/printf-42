...
/*   Updated: 2019/02/18 10:36:37 by nde-maes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// because it seems that I have to cast explicitly when I pass the function
unsigned long long	get_n_abs(long long n, int size)
{
...
char				get_hexa_letter(int hex_modulo, int maj)
{
	char				letter;
